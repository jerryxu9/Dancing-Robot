############################## Start of graphics.py ##############################
import os
import time
import displayio

# Parent class to Image and GIF
class Graphic():
    def get_name(self):
        pass
...
# Opens the image file and gets it ready to be displayed
class Image(Graphic):
...
# Opens all the image files and gets them ready to be displayed
class GIF(Graphic):
...
# Contains functionality to draw images to be displayed on LCD and removed from LCD
class Graphics():
